...
(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            //init status
            var result = this.options.getIsClosed(this);            
            this.toggable = result.toggable;
            if(this.toggable){
                this.setStatus(result.closed);
            }
            else{
            ...
            if(this.toggable){
                this.$handle.click(function(){
                    self.setStatus(!self.isClosed);
                });                
            }
        },
        
        setStatus: function(closed){
    ...
    $.extend(Plugin.prototype, {
        ...
        parseResult: function(data){
            ...
            for(var field in data['message']){
                var fieldSelector = this.options.fieldSelector.replace('{field}', field);

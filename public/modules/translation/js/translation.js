...
//        alert(grid_params);
        ajaxForm.dialog('/'+CURR_LANG + "/translation/admin/export-to-excel?grid_params="+urlencode(grid_params));
        return;
    }
...
//default on close action for ajax dialog
    ajaxForm.dialogOptions.onClose = function(success, data){
        if(success){
...
//    ajaxForm.dialogOptions.onBeforeSave = function(dialog){
...
//        
//    }
    ajaxForm.dialogOptions.width = "450";
    ajaxForm.dialogOptions.height = "400";
    ajaxForm.dialogOptions.saveCaption = "Export";

    ...
    public function contactListAction(){
        ...
        foreach ($records as $record) {
            $data['rows'][] = array(
                ...
                'first_name'            => addslashes($record->get_first_name()),
                'last_name'             => addslashes($record->get_last_name()),
                'email'                 => addslashes($record->get_email()),
                'street'               => addslashes($record->get_street()),
                'country'               => addslashes($record->get_country()),
                'phone'               => addslashes($record->get_phone()),
                'mobile'               => addslashes($record->get_mobile()),
                'fax'               => addslashes($record->get_fax()),
                'zip'                 => addslashes($record->get_zip()),
                'city'                => addslashes($record->get_city()),
                'gender'               => addslashes($this->translate($record->get_gender())),
                'description'           => addslashes($record->get_description()),
                'description_short'     => addslashes($this->view->abbreviate($record->get_description(), 150)),
